    ...
    return (
        <section className="min-h-screen relative flex flex-col items-center pt-10">
            ...
            <svg className="absolute top-[344px] left-1/2 transform -translate-x-[48px] -translate-y-1/2" width="100" height="200">
                <path d="M19,0 Q34,67 51,268" stroke="#A362FF" stroke-width="0.5" fill="transparent"></path>
            </svg>

            <svg className="absolute top-[344px] left-1/2 transform -translate-x-[40px] -translate-y-1/2" width="100" height="200">
                <path d="M70,0 Q34,67 40,268" stroke="#A362FF" stroke-width="0.5" fill="transparent"></path>
            </svg>

            <svg className="absolute top-[344px] left-1/2 transform -translate-x-[82px] -translate-y-1/2" width="100" height="200">
                <path d="M0,0 Q62,91 88,268" stroke="#A362FF" stroke-width="0.5" fill="transparent"></path>
            </svg>

            <svg className="absolute top-[344px] left-1/2 transform -translate-x-[19px] -translate-y-1/2" width="100" height="200">
                <path d="M100,0 Q37,63 17,223" stroke="#A362FF" stroke-width="0.5" fill="transparent"></path>
            </svg>

            <svg className="absolute top-[344px] left-1/2 transform translate-x-[35px] -translate-y-1/2" width="100" height="200">
                <path d="M98,0 Q0,67 0,273" stroke="#A362FF" stroke-width="0.5" fill="transparent"></path>
            </svg>

            <svg className="absolute top-[344px] left-1/2 transform -translate-x-[80px] -translate-y-1/2" width="100" height="200">
                <path d="M98,0 Q0,67 0,200" stroke="#A362FF" stroke-width="0.5" fill="transparent"></path>
            </svg>
        </section>
    );
};
